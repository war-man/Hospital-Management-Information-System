...
namespace Caresoft2._0.Areas.CareSoftReports.Controllers
{
    ...
    public class HomeReportsController : Controller
    {
        ...
        private object GetNewClientsServedData(DateTime FromDate, DateTime ToDate)
        {
            ...
            var NMPAdult = db2.NutritionAdultRegisters.Count(e => e.gender == "M" && e.age > 17 /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NFPAdult = db2.NutritionAdultRegisters.Count(e => e.gender == "F" && e.age > 17 /*&& e.ServicePoint == "CCC" */&& e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMP15To17 = db2.NutritionAdultRegisters.Count(e => e.gender == "M" && e.age >= 15 && e.age <= 17 /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NFP15To17 = db2.NutritionAdultRegisters.Count(e => e.gender == "F" && e.age >= 15 && e.age <= 17 /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMPPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("pregnant") || e.maternalNutrition.Trim().ToLower().Contains("postnatal") && e.gender == "M" /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NFPPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.gender == "F" /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var NMP5To15 = db2.NutritionChildRegisters.Count(e => e.gender == "M" && e.age >= 5 && e.age <= 15 /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NFP5To15 = db2.NutritionChildRegisters.Count(e => e.gender == "F" && e.age >= 5 && e.age <= 15 /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NPReadmission = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("readmission") /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NPRelapse = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("relapse") /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var NMN15To17 = db2.NutritionAdultRegisters.Count(e => e.gender == "M" && e.age >= 15 && e.age <= 17/* && e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NFN15To17 = db2.NutritionAdultRegisters.Count(e => e.gender == "F" && e.age >= 15 && e.age <= 17 /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMNPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("pregnant") || e.maternalNutrition.Trim().ToLower().Contains("postnatal") && e.gender == "M" /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NFNPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("pregnant") || e.maternalNutrition.Trim().ToLower().Contains("postnatal") && e.gender == "F" /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var NMN5To15 = db2.NutritionChildRegisters.Count(e => e.gender == "M" && e.age >= 5 && e.age <= 15 /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NFN5To15 = db2.NutritionChildRegisters.Count(e => e.gender == "F" && e.age >= 5 && e.age <= 15 /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NNReadmission = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("readmission") /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NNRelapse = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("relapse")/*&& e.ServicePoint != "CCC"*/ && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NNLinkedOVC = db2.NutritionAdultRegisters.Count(e => e.LinkedOVC == "Yes" && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var RP15To17 = db2.NutritionAdultRegisters.Count(e => e.age >= 15 /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RPPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("pregnant") || e.maternalNutrition.Trim().ToLower().Contains("postnatal")/*&& e.ServicePoint == "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var RP5To15 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RPReadmission = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("readmission") /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RPRelapse = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("relapse") /*&& e.ServicePoint == "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var RNAdult = db2.NutritionAdultRegisters.Count(e => e.age > 17 /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RN15To17 = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RNPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("pregnant") || e.maternalNutrition.Trim().ToLower().Contains("postnatal") /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var RN5To15 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RNReadmission = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("readmission")/*&& e.ServicePoint != "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RNRelapse = db2.NutritionAdultRegisters.Count(e => e.SamMamClients.Trim().ToLower().Contains("relapse") /*&& e.ServicePoint != "CCC"*/ && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
        ...
        private object GetNewSAMData(DateTime FromDate, DateTime ToDate)
        {
            ...
            var PSAMAdult = db2.NutritionAdultRegisters.Count(e => e.age > 17 && /*e.ServicePoint == "CCC"*/ e.NutritionStatus.Trim().ToLower().Contains("sam") && e.date_time >= FromDate && e.date_time <= ToDate);
            var PMAMAdult = db2.NutritionAdultRegisters.Count(e => e.age > 17 /*&& e.ServicePoint == "CCC"*/ && e.NutritionStatus.Trim().ToLower().Contains("mam") && e.date_time >= FromDate && e.date_time <= ToDate);
            var PSAM15To17 = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 /*&& e.ServicePoint == "CCC"*/ && e.NutritionStatus.Trim().ToLower().Contains("sam") && e.date_time >= FromDate && e.date_time <= ToDate);
            var PMAM15To17 = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && /*e.ServicePoint == "CCC" && */e.NutritionStatus.Trim().ToLower().Contains("mam") && e.date_time >= FromDate && e.date_time <= ToDate);
            var PSAMPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.NutritionStatus.Trim().ToLower().Contains("sam") /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var PMAMPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.NutritionStatus.Trim().ToLower().Contains("mam") /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var PSAM0To59M = db2.NutritionChildRegisters.Count(e => e.age <= 5 /*&& e.ServicePoint == "CCC"*/ && e.NutritionStatus.Trim().ToLower().Contains("sam") && e.date_time >= FromDate && e.date_time <= ToDate);
            var PMAM0To59M = db2.NutritionChildRegisters.Count(e => e.age <= 5 /*&& e.ServicePoint == "CCC"*/ && e.NutritionStatus.Trim().ToLower().Contains("mam") && e.date_time >= FromDate && e.date_time <= ToDate);
            var PSAM5To15 = db2.NutritionChildRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("sam") && e.age >= 5 && e.age <= 15 /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var PMAM5To15 = db2.NutritionChildRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("mam") && e.age >= 5 && e.age <= 15  /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NSAMAdult = db2.NutritionAdultRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("sam") && e.age > 15 /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAMAdult = db2.NutritionAdultRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("mam") && e.age > 15 /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NSAM15To17 = db2.NutritionAdultRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("sam") && e.age >= 15 - 17 /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAM15To17 = db2.NutritionAdultRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("mam") && e.age >= 15 - 17 /*&& e.ServicePoint != "CCC*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NSAMPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.NutritionStatus.Trim().ToLower().Contains("sam") /*&& e.ServicePoint != "CCC" */&& e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAMPost = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.NutritionStatus.Trim().ToLower().Contains("mam") /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NSAM0To59 = db2.NutritionChildRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("sam") && e.age <= 5 /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAM0To59 = db2.NutritionChildRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("mam") && e.age <= 5 && /*e.ServicePoint != "CCC"*/  e.date_time >= FromDate && e.date_time <= ToDate);
            var NSAM5To15 = db2.NutritionAdultRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("sam") && e.age >= 5 && e.age > 15 /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAM5To15 = db2.NutritionAdultRegisters.Count(e => e.NutritionStatus.Trim().ToLower().Contains("sam") && e.age >= 5 && e.age > 15 /*&& e.ServicePoint != "CCC" */&& e.date_time >= FromDate && e.date_time <= ToDate);
        ...
        private object GetNewARTData(DateTime FromDate, DateTime ToDate)
        {
            ...
            var NTBAdult = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age > 17 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NTB15To17 = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age >= 15 && e.age <= 17 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NTBPost = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NTB0To59M = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age <= 5 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NTB5To15 = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age >= 5 && e.age <= 15 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NDiarrhoeaAdult = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age > 15 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NDiarrhoea15To17 = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 15 && e.age <= 17 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NDiarrhoeaPost = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NDiarrhoea0To59M = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age <= 5 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NDiarrhoea5To15 = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 5 && e.age <= 15 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NOtherOIsAdult = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age > 17 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NOtherOIs15To17 = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 15 && e.age <= 17 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NOtherOIsPost = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NOtherOIs0To59M = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age <= 5 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var NOtherOIs5To15 = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 5 && e.age <= 15 && e.VisitType == "New" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RTBAdult = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age > 17 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RTB15To17 = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age >= 15 && e.age <= 17 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RTBPost = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RTB0To59M = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age <= 5 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RTB5To15 = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToUpper().Contains("TB") && e.age >= 5 && e.age <= 15 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RDiarrhoeaAdult = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age > 15 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RDiarrhoea15To17 = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 15 && e.age <= 17 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RDiarrhoeaPost = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RDiarrhoea0To59M = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age <= 5 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var RDiarrhoea5To15 = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 5 && e.age <= 15 && e.VisitType == "Revist" && e.date_time >= FromDate && e.date_time <= ToDate);
            var ROtherOIsAdult = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age > 15 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var ROtherOIs15To17 = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 15 && e.age <= 17 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var ROtherOIsPost = db2.NutritionAdultRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.maternalNutrition.Trim().ToLower().Contains("postnatal") || e.maternalNutrition.Trim().ToLower().Contains("pregnant") && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var ROtherOIs0To59 = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age <= 5 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
            var ROtherOIs5To15 = db2.NutritionChildRegisters.Count(e => e.CoexistingConditions.Trim().ToLower().Contains("diarrhoea") && e.age >= 5 && e.age <= 15 && e.VisitType == "Revisit" && e.date_time >= FromDate && e.date_time <= ToDate);
        ...
        private object GetNewAnaemiaData(DateTime? FromDate, DateTime? ToDate)
        {
            ...
            var NSAdultP = db2.NutritionAdultRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("severe") && e.VisitType == "New" /*&& e.ServicePoint == "CCC"*/ && e.age > 17 && e.OnARVs.Trim().ToLower().Contains("yes") && e.date_time >= FromDate && e.date_time <= ToDate);
            var NSAdultN = db2.NutritionAdultRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("severe") && e.VisitType == "New" /*&& e.ServicePoint != "CCC"*/ && e.age > 17 && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var NSAllChildren = db2.NutritionChildRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("severe") && e.VisitType == "New" && e.age <= 17 && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAdultP = db2.NutritionAdultRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("moderate") && e.OnARVs.Trim().ToLower().Contains("yes") && e.VisitType == "New" /*&& e.ServicePoint == "CCC"*/ && e.age > 15 && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAdultN = db2.NutritionAdultRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("moderate") && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.VisitType == "New" /*&& e.ServicePoint != "CCC"*/ && e.age > 15 && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMAllChildren = db2.NutritionChildRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("moderate") && e.VisitType == "New" && e.age <= 17 && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMiAdultP = db2.NutritionAdultRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("mild") && e.VisitType == "New" /*&& e.ServicePoint == "CCC"*/ && e.age > 15 && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMiAdultN = db2.NutritionAdultRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("mild") && e.VisitType == "New" /*&& e.ServicePoint != "CCC"*/ && e.age > 15 && e.date_time >= FromDate && e.date_time <= ToDate);
            var NMiAllChildren = db2.NutritionChildRegisters.Count(e => e.Anaemia.Trim().ToLower().Contains("mild") && e.VisitType == "New" && e.age <= 17 && e.date_time >= FromDate && e.date_time <= ToDate);
        ...
        private object GetNewInfantData(DateTime FromDate, DateTime ToDate)
        {
            ...
            var EBF = db2.NutritionChildRegisters.Count(e => e.First0to6Months == "Exclusive Breastfeeding" /*&& e.ServicePoint == "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var ERF = db2.NutritionChildRegisters.Count(e => e.First0to6Months == "Exclusive replacement feeding" /*&& e.ServicePoint == "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var MF = db2.NutritionChildRegisters.Count(e => e.First0to6Months == "Mixed feeding" /*&& e.ServicePoint == "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var BF = db2.NutritionChildRegisters.Count(e => e.Sixto12Months == "Breastfeeding" /*&& e.ServicePoint == "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var NBF = db2.NutritionChildRegisters.Count(e => e.Sixto12Months == "Not breastfeeding" /*&& e.ServicePoint == "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var NK = db2.NutritionChildRegisters.Count(e => e.Sixto12Months == "Not Known" /*&& e.ServicePoint == "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var BCF = db2.NutritionChildRegisters.Count(e => e.Sixto12Months == "Began complimentary feeding" /*&& e.ServicePoint == "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("no") || e.OnARVs == null && e.date_time >= FromDate && e.date_time <= ToDate);
            var EBF1 = db2.NutritionChildRegisters.Count(e => e.First0to6Months == "Exclusive Breastfeeding" /*&& e.ServicePoint != "CCC"*/&& e.OnARVs.Trim().ToLower().Contains("yes") && e.date_time >= FromDate && e.date_time <= ToDate);
            var ERF1 = db2.NutritionChildRegisters.Count(e => e.First0to6Months == "Exclusive replacement feeding" /*&& e.ServicePoint != "CCC"*/&& e.OnARVs.Trim().ToLower().Contains("yes") && e.date_time >= FromDate && e.date_time <= ToDate);
            var MF1 = db2.NutritionChildRegisters.Count(e => e.First0to6Months == "Mixed feeding" /*&& e.ServicePoint != "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("yes") && e.date_time >= FromDate && e.date_time <= ToDate);
            var BF1 = db2.NutritionChildRegisters.Count(e => e.Sixto12Months == "Breastfeeding" /*&& e.ServicePoint != "CCC"*/ && e.OnARVs.Trim().ToLower().Contains("yes") && e.date_time >= FromDate && e.date_time <= ToDate);
            var NBF1 = db2.NutritionChildRegisters.Count(e => e.Sixto12Months == "Not breastfeeding" /*&& e.ServicePoint != "CCC"*/&& e.OnARVs.Trim().ToLower().Contains("yes") && e.date_time >= FromDate && e.date_time <= ToDate);
            var NK1 = db2.NutritionChildRegisters.Count(e => e.Sixto12Months == "Not Known" /*&& e.ServicePoint != "CCC"*/&& e.OnARVs.Trim().ToLower().Contains("yes") && e.date_time >= FromDate && e.date_time <= ToDate);
        ...
        {
            var One = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition == "Pre-natal" && e.age >= 15 && e.age <= 17 /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var Two = 0;
            ...
            var Six = 0;
            var Seven = 0;
            var Eight = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition == "Post-natal" && e.age >= 15 && e.age <= 17 /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Thirteen = 0;
            var Fourteen = 0;
            var Fifteen = db2.NutritionAdultRegisters.Count(e => e.CriticalNutritionPractices != null && e.age >= 15 && e.age <= 17 /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Nineteen = db2.NutritionAdultRegisters.Count(e => e.CriticalNutritionPractices != null && e.age >= 5 && e.age <= 15 /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var TwentyOne = db2.NutritionAdultRegisters.Count(e => e.CriticalNutritionPractices != null && e.age >= 5 && e.age <= 15 /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var TwentyTwo = 0;
            var TwentyThree = 0;
            var TwentyFour = 0;
            var TwentyFive = 0;
            ...
            var TwentySeven = 0;
            var TwentyEight = 0;
            var TwentyNine = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.TherapeuticFoods == "F75||F100" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var Thirty = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition == "Post-natal" && e.TherapeuticFoods == "F75||F100" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var ThirtyOne = db2.NutritionAdultRegisters.Count(e => e.age > 15 && e.TherapeuticFoods == "F75||F100" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var ThirtyTwo = db2.NutritionChildRegisters.Count(e => e.age <= 5 && e.TherapeuticFoods == "F75||F100" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var ThirtyThree = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.TherapeuticFoods == "F75||F100" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var ThirtyFour = db2.NutritionChildRegisters.Count(e => e.age <= 5 && e.TherapeuticFoods == "F75||F100" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var ThirtyFive = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.TherapeuticFoods == "F75||F100" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var ThirtySix = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.TherapeuticFoods == "RUTF" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Fourty = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.TherapeuticFoods == "RUTF" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var FourtyTwo = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.TherapeuticFoods == "RUTF" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var FourtyThree = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.SupplementalFoods == "RUSF" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var FourtySeven = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.SupplementalFoods == "RUSF" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var FourtyNine = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.SupplementalFoods == "RUSF" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var Fifty = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.SupplementalFoods == "FBF||CSB" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var FiftyFour = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.SupplementalFoods == "FBF||CSB" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var FiftySix = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.SupplementalFoods == "FBF||CSB" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var FiftySeven = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.SupplementalFoods == "Liquid Nutrition Supplements" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var SixtyOne = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.SupplementalFoods == "Liquid Nutrition Supplements" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var SixtyThree = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.SupplementalFoods == "Liquid Nutrition Supplements" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var SixtyFour = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.Micronutrients != null /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var SixtyEight = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.Micronutrients != null /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Seventy = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.Micronutrients != null /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);

            var SeventyOne = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.TherapeuticFoods == "Others" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var SeventyFive = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.TherapeuticFoods == "Others" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var SeventySeven = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.TherapeuticFoods == "Others" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var SeventyEight = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.OutcomeClient == "Gaining Weight" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var EightyTwo = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Gaining Weight" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var EightyFour = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Gaining Weight" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var EightyFive = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.OutcomeClient == "Loosing Weight" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var EightyNine = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Loosing Weight" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var NinetyOne = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Loosing Weight" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NinetyTwo = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.OutcomeClient == "Static Weight" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var NinetySix = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Static Weight" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var NinetyEight = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Static Weight" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var NinetyNine = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.OutcomeClient == "Cured" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var HundredThree = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Cured" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var HundredFive = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Cured" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);

            var HundredSix = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.OutcomeClient == "Discharged" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var HundredTen = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Discharged" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var HundredTwelve = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Discharged" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var HundredThirteen = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.OutcomeClient == "Discharged" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var HundredFourteen = db2.NutritionAdultRegisters.Count(e => e.maternalNutrition == "Post-natal" && e.OutcomeClient == "Discharged" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var HundredSeventeen = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Discharged" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var HundredNineteen = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.OutcomeClient == "Discharged" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var HundredTwenty = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.ReferralsandTransfers == "Referral for in-patient care||Referral to other clinics" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Hundred24 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.ReferralsandTransfers == "Referral for in-patient care||Referral to other clinics" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Hundred26 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.ReferralsandTransfers == "Referral for in-patient care||Referral to other clinics" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var Hundred27 = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.ReferralsandTransfers == "Referral for livelihood support(food insecure)" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Hundred31 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.ReferralsandTransfers == "Referral for livelihood support(food insecure)" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Hundred33 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.ReferralsandTransfers == "Referral for livelihood support(food insecure)" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            var Hundred34 = db2.NutritionAdultRegisters.Count(e => e.age >= 15 && e.age <= 17 && e.ReferralsandTransfers == "Transferred" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Hundred38 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.ReferralsandTransfers == "Transferred" /*&& e.ServicePoint == "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
            ...
            var Hundred40 = db2.NutritionChildRegisters.Count(e => e.age >= 5 && e.age <= 15 && e.ReferralsandTransfers == "Transferred" /*&& e.ServicePoint != "CCC"*/ && e.date_time >= FromDate && e.date_time <= ToDate);
